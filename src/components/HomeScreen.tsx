...
export function HomeScreen({ impostorCount, setImpostorCount, category, setCategory, onNext }: HomeScreenProps) {
    return (
                ...
                <div className="space-y-6">
                    ...
                    <div>
                        ...
                        <select
                            ...
                            className="w-full bg-white/10 border-2 border-blue-500/30 rounded-xl px-4 py-3 text-lg font-semibold focus:border-blue-500 focus:ring-4 focus:ring-blue-500/20 outline-none transition-all appearance-none"
                        >
